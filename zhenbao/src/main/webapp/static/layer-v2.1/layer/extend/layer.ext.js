...
;!function () {
    ...
    layer.prompt = function (a, c) {
        ...
        var d, e = 2 == a.formType ? '<textarea class="layui-layer-input">' + (a.value || "") + "</textarea>" : function () {
            return '<input type="' + (1 == a.formType ? "password" : "text") + '" class="layui-layer-input" value="' + (a.value || "") + '" placeholder="' + (a.placeholder || "") + '">'
        }();
        ...
        if (a = a || {}, a.photos) {
            ...
            f.imgprev = function (a) {
                ...
                layer.close(f.loadi), f.index = layer.open($.extend({
                    type: 1,
                    area: function () {
                        var b = [c.width - 200, c.height - 200], d = [$(window).width() - 100, $(window).height() - 100];
